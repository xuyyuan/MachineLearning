import numpy as np
from .metrics import accuracy_score  # 解决分类问题

class LogisticRegression:

    def __init__(self):
        """初始化 LogisticRegression模型"""
    ...
    def fit(self, X_train, y_train, eta=0.01, n_iters=1e4, epsilon=1e-8):
        ...
        def dJ(theta, X_b, y):
            return X_b.T.dot(self._sigmoid(X_b.dot(theta)) - y) / len(X_b)  # 使用向量化的方法
    ...
    def predict_proba(self, X_predict):
        ...
        return self._sigmoid(X_b.dot(self._theta)) # youmeiyoucuowu a ?
